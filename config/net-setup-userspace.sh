...
net_user() {
	...
	echo "-net user,vlan=$net,net=192.168.0.$nodeid/24,host=192.168.0.250,ipv6-net=2000::/64,ipv6-host=2000::250,hostfwd=tcp:127.0.0.1:$pt-192.168.0.$nodeid:23,hostfwd=tcp:127.0.0.1:$ps-192.168.0.$nodeid:22$k8s"
}
