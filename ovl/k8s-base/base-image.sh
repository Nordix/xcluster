...
## base-image.sh --
##
##   Help script for the xcluster ovl/base-image.
##
## Commands;
##
...
cmd_env() {
	...
	test "$__version" || __version=latest
	__tag="registry.nordix.org/cloud-native/xcluster-base:$__version"
...
test_start() {
	...
	export __nrouters=0
	xcluster_start k8s-test k8s-base

	otcprog=k8s-test_test
	otc 1 check_namespaces
	otc 1 check_nodes
	unset otcprog
	otcprog=base-image_test
	otc 1 start_base_image
}
